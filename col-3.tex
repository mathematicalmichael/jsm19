...
\centering
        \heading{Goal: Obtain the Best Value of $\lambda$} 
            {\large \textbf{Bayesian Context:} Bayes model uses assumed likelihood function of data given $\lambda$.}
...
\centering
\heading{Convergence of Data Consistent Approach}
